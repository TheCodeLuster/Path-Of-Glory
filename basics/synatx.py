# // https://learnxinyminutes.com/python/ and a bit of my code
...
"""
Encapsulation is the practice of bundling the data (attributes) and the methods (functions) 
that operate on the data into a single unit, typically a class. It also restricts access 
to some of the object's components, which is crucial for hiding the internal state of the object 
...
class Person:
    ...
    def get_ssn(self):
        return self.__ssn          # Accessing private attribute via a public method
...
It allows the user to work with the object at a higher level without 
worrying about the internal complexities.
"""
...
It also allows methods with the same name to behave differently 
based on the object they are called on.
"""
